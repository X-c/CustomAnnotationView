...
@interface HQMMapViewController ()<MAMapViewDelegate>
@property (weak, nonatomic) IBOutlet UILabel *tipLabel;
@property (nonatomic, strong) MAMapView *mapView;
@property (nonatomic, strong) NSArray *anns;
@end

@implementation HQMMapViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    HQMCustomAnnotation *ann = self.anns.firstObject;
...
- (void)setupModels {
    ...
    HQMCustomAnnotation *maleAnn = [[HQMCustomAnnotation alloc] init];
    ...
    HQMCustomAnnotation *femaletuAnn = [[HQMCustomAnnotation alloc] init];
...
- (MAAnnotationView *)mapView:(MAMapView *)mapView viewForAnnotation:(id<MAAnnotation>)annotation {
    ...
    else if ([annotation isKindOfClass:[HQMCustomAnnotation class]]) {
